...
```json
{
  ...
  "explorer.fileNesting.patterns": {
    "CLAUDE.md": "SPEC.md, ARCHITECTURE.md, DECISIONS.md, SESSION_LOG.md, KNOWN_ISSUES.md, LESSONS_LEARNED.md, IMPROVEMENTS.md, TESTING.md, UI_UX.md, BUSINESS_LOGIC.md, EXTERNAL_SERVICES.md, AI_CHANGELOG.md, WORKFLOW.md, SECURITY.md, SELF_LEARNING.md, 3MEK.md, MARKETING_ASSETS.md",
...
## Fișiere noi obligatorii

- Citește `SELF_LEARNING.md` la planificarea fiecărui task
- Citește `SECURITY.md` când task-ul atinge auth/plăți/date personale
- Citește `3MEK.md` pentru decizii cu impact pe firmă
- `MARKETING_ASSETS.md` — doar pentru proiecte de firmă

## Tip proiect

La orice proiect nou întreabă: Personal sau Firmă?
Pașii cu ★ se execută DOAR pentru proiecte de firmă.

## Self-learning

Adaugă în SELF_LEARNING.md după orice greșeală corectată.
La finalul fiecărui task propune: 1 sugestie app + 1 sugestie sistem agenți + 1 sugestie tehnică.
