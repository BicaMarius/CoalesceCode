...
| **Data estimata MVP**   | `TBD (se stabileste dupa primul sprint de executie)` |
| **Durata estimata MVP** | `TBD`                                                |
...
| ------------------- | --------------------- | ---------------------------------- | ----------------------- | --------------- |
| Marius Bica         | Product + Engineering | Fullstack                          | JavaScript / TypeScript | variabila       |
...
```
Scenariu pesimist:  TBD
Scenariu realist:   TBD
Scenariu optimist:  TBD
```
...
```
Total ore estimate MVP: in curs de estimare
Ore disponibile / saptamana (echipa totala): variabil
Saptamani necesare: TBD
```
